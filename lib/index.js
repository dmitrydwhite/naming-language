var NLanguage = function (obj) {
  return obj;
}

var NamingLanguage = function () {
  ...
  var choose = function (list, exponent) {
      exponent = exponent || 1;
  ...
  var makeSyllable = function (lang) {
      while (true) {
          var syll = "";
  ...
  var getMorpheme = function (lang, key) {
      if (lang.nomorph) {
  ...
  var makeWord = function (lang, key) {
  ...
  var makeName = function (lang, key) {
      if ( !(lang instanceof NLanguage) ) return { err: 'Language passed is not of correct type' };
      key = key || '';
  ...
  var makeBasicLanguage = function () {
    return new NLanguage({
      phonemes: {
        C: "ptkmnls",
        V: "aeiou",
        S: "s",
  ...
  var makeOrthoLanguage = function () {
    var lang = makeBasicLanguage();
    lang.noortho = false;
    return lang;
  };

  var makeRandomLanguage = function () {
    var lang = makeBasicLanguage();
    lang.noortho = false;
    lang.nomorph = false;
  ...
  return {
    makeRandomLanguage: makeRandomLanguage,
    makeName: makeName,
    makeOrthoLanguage: makeOrthoLanguage,
    makeBasicLanguage: makeBasicLanguage
  };
};


module.exports = new NamingLanguage();